...
function render(array) {
  ...
  for (let i = 0; i < array.length; ++i) {
    ...
    itemDiv.setAttribute("class","d-flex justify-content-between taskBox p-3 my-2  mx-auto align-items-center");
    ...
    completedIcon.setAttribute("class","fa-solid fa-check border border-2 bg-body-secondary p-2 fs-3  completeTask ");
    completedIcon.setAttribute("onclick",`completeTask('${i}')`);

    const deleteIcon=document.createElement("i");
    deleteIcon.setAttribute("class","fa-solid fa-trash border border-2 bg-body-secondary p-2 fs-3  deleteTask");

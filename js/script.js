...
function render(array) {
    ...
    for (let i = 0; i < array.length; ++i) {
        todoContainer.innerHTML +=
            `<div class=" d-flex justify-content-between taskBox p-3 my-2  mx-auto align-items-center">
                <div class="fs-3 px-2 input-text ${array[i].completed ? "line-through" : ""}">${array[i].title}</div>
